# Este programa calcula el número de segundos en un número determinado de horas

# Se define el número de horas que se van a convertir en segundos
hours = 2  # Número de horas

# Se define la cantidad de segundos en una hora
seconds_per_hour = 3600  # Número de segundos en una hora

# Imprime el número de horas
print("Horas:", hours)

# Calcula e imprime el número de segundos en el número de horas especificado
total_seconds = hours * seconds_per_hour
print("Segundos en", hours, "horas:", total_seconds)
